import ourMission from "../../../Assets/Images/mission.png";
import coreValues from "../../../Assets/Images/value.png";
import ourVision from "../../../Assets/Images/vision.png";
  ...
  return (
    <section id="Statement" className={styles.statementContainer}>
      ...
      <section>
        ...
        <article className={`SN-D-P-22 ${styles.slideInTextFromLeft}`}>
          ...
          <p className={`SN-D-P-22 ${styles.blueParagraph}`}>
      ...
      <section>
        ...
        <article className="SN-D-P-22">
          <aside className={styles.hoverEffect}>
            <h2 className="SN-D-H3-24">Patient-Centered Care</h2>
            <p className="SN-D-P-22">
          ...
          <aside className={styles.hoverEffect}>
            <h2 className="SN-D-H3-24">Innovation</h2>
            <p className="SN-D-P-22">
          ...
          <aside className={`SN-D-P-22 ${styles.blueParagraph}`}>
            <h2 className="SN-D-H3-24">Integrity</h2>
            <p className="SN-D-P-22">
          ...
          <aside className={styles.hoverEffect}>
            <h2 className="SN-D-H3-24">Social Responsibility</h2>
            <p className="SN-D-P-22">
          ...
          <aside className={`SN-D-P-22 ${styles.blueParagraph}`}>
            <h2 className="SN-D-H3-24">Collaboration</h2>
            <p className="SN-D-P-22">
          ...
          <aside className={styles.hoverEffect}>
            <h2 className="SN-D-H3-24">Professionalism</h2>
            <p className="SN-D-P-22">
      ...
      <section>
        ...
        <article className={`SN-D-P-22 ${styles.slideInTextFromRight}`}>
          <p className="SN-D-P-22">
