      ...
      <div className="page-holder">
        ...
        >
          ...
          <h3 className="team-directors-tab SN-D-P-22">
            ...
            and board members. Their selfless contributions are indispensable in
            helping us fulfill our mission. Without their support, we would not
            be able to make a difference and shape a better future for patients
            with complex diseases. Together, we are committed to bringing about
            positive change and improving the lives of those we serve.
          </h3>
        </div>
        <div
          className={`gridd ${isVisible.divTwoRef ? "slide-in" : ""}`}
          ref={divTwoRef}
        >
          {/* 
