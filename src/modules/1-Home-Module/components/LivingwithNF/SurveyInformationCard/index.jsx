    ...
    return (
      <div key={index} className={styles.cardContainer}>
        <h2 className={styles.cardHeader}>
          <span className={`${styles.dH1_32} ${styles.part1} ${styles.surveyToday} SN-H2`}>{part1}</span>
          <span  className={` ${styles.part2} ${styles.dH3_24} SN-H3`}>{part2}</span>
        </h2>
        <div className={styles.contentSection}>
          ...
          <p className={`${styles.dP_20} SN-P-Big`}>{text}</p>
          <div className={styles.btnContainer}>
            <button
              className={`${styles.dTM_P_B_16} SN-Button`}
