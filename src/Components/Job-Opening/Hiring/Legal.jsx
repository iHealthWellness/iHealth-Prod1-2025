      ...
      <div className="layerOne-tab">
        <div>
          ...
          <div className="job-body">
            {legalVisible && (
              <div className="grid">
                <Link className="grid-title link-text" to="https://app.dover.io/apply/2d71c19b-3348-4bae-bbc2-a5ea3d500bc7/3874eb95-22f3-4765-b95f-e96405900ad6/?rs=15190316">Corporate Attorney</Link>
          ...
          <div className="job-body">
            {legalVisible && (
              <div className="grid">
                <Link className="grid-title link-text" to="https://app.dover.io/apply/2d71c19b-3348-4bae-bbc2-a5ea3d500bc7/be38fc34-67a5-4ec8-b5d4-ea1cde222f01/?rs=15190316">Healthcare Regulatory Compliance Specialist</Link>
