    ...
    <div>
      ...
      <div className="text-tab-flow">
        ...
        <p className="description-text">
          ...
          to recruit VOLUNTEERS as UX RESEARCHER - MEDICAL/ WELLNESS
          PROVIDER LOOKUP.
        </p>
        <p className="description-text">
          As a UX Researcher, you will be responsible for conducting
          user research, analyzing data, and delivering insights that
          inform the design and development of our product.
        </p>
        ...
        <ul className="responsibilities-text">
          ...
          <li>
            Collaborate with UX Designers and Product Manager to
            translate user research insights into design recommendations
            and product improvements.
          </li>
          <li>
            Work with the Development team to ensure the implementation
            of design recommendations and usability improvements.
          </li>{" "}
          <li>
        ...
        <ul className="qualifications-text">
          ...
          <li>
            ...
            usability testing, surveys, focus groups, and user
            interviews.
          </li>
          <li>
          ...
          <li>
            ...
            quickly • Ability to commit to a minimum of 4+ hour work
            weeks
          </li>
          <li>
      ...
      <div className="text-tab-flow">
        ...
        <p className="description-text">
          We are an 'early stage' pre-money nonprofit/ tech startup
          preparing for a proof-of-concept launch / seed-raise looking
          to recruit VOLUNTEERS (unpaid) as UX/UI DESIGNERS.{" "}
        </p>
        <p className="description-text">
        ...
        <p className="description-text">
          ...
          product area (web, ios, android). You’ll help drive the
          roadmap, presenting and evaluating options, and crafting the
          approach. Within the team, you will be expected to mentor more
          junior team members.
        </p>
        <p className="description-text">
        ...
        <ul className="responsibilities-text">
          ...
          <li>
            Help shape our brand through both product and marketing
          </li>
        </ul>
        <h3 className="qualifications-title">Qualifications</h3>
        <ul className="qualifications-text">
