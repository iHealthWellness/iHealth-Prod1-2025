    ...
    <div className="layerTwo-tab">
      <div>
        <div className="flex-tab">
          <h3 className="Text-header">QUALITY ASSURANCE</h3>
          <BntTab
        ...
        <div className="text-tab-flow">
          ...
          <ul className="responsibilities-text">
            <li>
              Evaluate, analyze, author and communicate systems requirements on
              a continuing basis, and maintain systems processes
            </li>
            <li>
            ...
            <li>
              ...
              test cases • Estimate, prioritize, plan and coordinate testing
              activities
            </li>
            <li>
            ...
            <li>
              Investigate the causes of non-conforming software and train users
              to implement solutions Track quality assurance metrics, like
              defect densities and open defect counts
            </li>
          ...
          <ul className="qualifications-text">
            ...
            <li>Experience in generating process documentation and reports</li>
            <li>
