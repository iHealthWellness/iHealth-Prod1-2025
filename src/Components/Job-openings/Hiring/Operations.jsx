    ...
    <div className="layerTwo-tab">
      <div>
        ...
        <div className="job-body">
          ...
          <hr />
          {operationsVisible && (<div>
            {accordion.aspect && (
              <div className="text-tab-flow">
                <h2 className="description-title">Description</h2>
                <ul className="description-text">
                  <li>
                    Research and build relationships with companies specializing
                    in treatments for complex diseases
                  </li>
                  <li>
                    Track trials that may be relevant to our community, providing
                    information such as research overview, times and lengths on
                    trials, etc.
                  </li>
                  <li>
                    Communicates with internal teams to understand patient
                    population and needs
                  </li>
                  <li>
                    Work closely with trial leaders to understand needs and
                    requirements for partnership and evaluate ROI for the business
                  </li>
                  <li>
                  ...
                  <li>
                    Create communications cadence and partner with internal teams
                    to keep platform up-to-date on activities
                  </li>
                </ul>
                ...
                <ul className="qualifications-text">
                  <li>
                    ...
                    development, international medicine or medical sales
                    experience, business development, strategic planning, or
                    related areas
                  </li>
                  <li>
                    Bachelor's degree in Health Care Administration or related
                    field, or the equivalent combination of education and/or
                    experience
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    ability to write clearly and concisely and proof read for
                    others
                  </li>
                  <li>
              ...
              {accordion.looking && (
                <div className="text-tab-flow">
                  ...
                  <p className="description-text">
                    ...
                    to recruit VOLUNTEERS (unpaid) as a Clinical Integration
                    Specialist collaborating with healthcare providers to
                  ...
                  <ul className="responsibilities-text">
                    <li>
                      Assist in the development of design specifications in
                      support of new or modified clinical applications, regulatory
                    ...
                    <li>
                      Acts as a liaison and represents the system users/customers
                      in all project initiatives
                    </li>
                    <li>
                      Performs post-implementation monitoring of adoption and use
                    </li>
                  </ul>
                  <h3 className="qualifications-title">Required Experience</h3>
                  <ul className="qualifications-text">
                    <li>
                      3+ years direct clinical experience, healthcare informatics
                      or healthcare operations experience preferred
                    </li>
                    <li>
                    ...
                    <li>
                      Current knowledge of clinical practices and related
                      information systems and computer applications
                    </li>
                    <li>
                      Maintains current knowledge of trends and advances in
                      clinical practice and healthcare informatics, as well as new
                      developments and innovations in hardware and software
                      technology
                    </li>
                    <li>
                  ...
                  <p className="note-text">
                    Please note that candidates actively seeking CPT/Internships
                    are ineligible for this particular volunteer position.
                    <br /> Through your pro-bono work, you will not only continue
                    to demonstrate your current skills while gaining some new
                    ones, practice teamwork, make new friends and develop
              ...
              {accordion.viewing && (
                <div className="text-tab-flow">
                  ...
                  <p className="description-text">
                    We are an 'early stage' pre-money nonprofit/ tech startup
                    preparing for a proof-of-concept launch / seed-raise looking
                    to recruit VOLUNTEERS (unpaid) as a Health Cloud
                    Infrastructure and Integration Specialist to designing,
                    analyzing, and integrating the platform for medical products.
                  </p>

                  <h3 className="responsibilities-title">Responsibilities</h3>
                  <ul className="responsibilities-text">
                    <li>
                      Take lead on designing, analyzing, and integrating the
                      platform for medical products
                    </li>
                    <li>
                      Provide ongoing support and maintain the strategic roadmap
                      for a portfolio of forthcoming products and offerings
                    </li>
                  </ul>
                  <h3 className="qualifications-title">Required Experience</h3>
                  <ul className="qualifications-text">
                    ...
                    <li>
                      Experience with software acquisition evaluation while
                      considering functional benefits, technical performance,
                      risks, and schedule concerns
                    </li>
                    <li>
                      Some application and infrastructure testing experience
                    </li>
                    <li>
                      Excellent critical thinking and analytical skills, with a
                    ...
                    <li>
                      Must be highly organized and self-motivating; maintaining
                      high integrity and high confidence
                    </li>
                    <li>
              ...
              {accordion.glimpse && (
                <div className="text-tab-flow">
                  ...
                  <p className="description-text">
                    We are an 'early stage' pre-money nonprofit/ tech startup
                    preparing for a proof-of-concept launch / seed-raise looking
                    to recruit VOLUNTEERS (unpaid) as a Physician Integration
                    Specialist to designing, analyzing, and integrating the
                    platform for medical products.
                  </p>
                  <h3 className="responsibilities-title">Responsibilities</h3>
                  <ul className="responsibilities-text">
                    <li>
                      Acts as primary contact for practices using the platform and
                      works collaboratively with our team to facilitate
                      communication and issue resolution
                    </li>
                    <li>
                      Participates in the development, implementation and
                      maintenance of a physician on-boarding program to ensure
                      physicians are able to work efficiently and knowledgeably
                      within our platform
                    </li>
                    <li>
                      Participates in the planning, implementation and
                      coordination of physician relations activities and
                      identifies growth opportunities for systems
                    </li>
                    <li>
                      Builds strong and mutually beneficial relationships amongst
                      the our physician network
                    </li>
                  </ul>
                  <h3 className="qualifications-title">Required Experience</h3>
                  <ul className="qualifications-text">
                    <li>
                      3+ years of experience in Healthcare, partnering with
                      Physicians
                    </li>
                    ...
                    <li>
                      Bachelor's degree in Health Care, Health Administration or
                      related field
                    </li>
                    <li>
                      Previous experience at a startup,consulting, or HealthTech
              ...
              {accordion.outlook && (
                <div className="text-tab-flow">
                  ...
                  <p className="description-text">
                    We are an 'early stage' pre-money nonprofit/ tech startup
                    preparing for a proof-of-concept launch / seed-raise looking
                    to recruit VOLUNTEERS (unpaid) as RESEARCH ANALYSTS.
                  </p>
                  <p className="description-text">
                    As the RESEARCH ANALYST volunteer you will contribute to
                    identifying market fit and competitive landscape.
                  </p>
                  <p className="description-text">
                  ...
                  <ul className="responsibilities-text">
                    <li>
                      Research, analyze, and write market reports to include
                      analysis of global and U.S. markets
                    </li>
                    <li>
                      Develop market fit & competitive landscape (pitch deck
                    ...
                    <li>
                      Act as company liaison for overall research efforts and
                      develop research tools such as calendars and workflows to
