    ...
    <div className="layerTwo-tab">
      <div>
        ...
        <div className="text-tab-flow">
          ...
          <p className="description-text">
            ...
            and building brand awareness. Future Salary would be
            promised for employees (after seed funding
          ...
          <ul className="responsibilities-text">
            ...
            <li>
              Engage with potential customers and target audience
              through online and offline channels to generate interest
          ...
          <ul className="qualifications-text">
            <li>
              Passion for health and wellness, with a strong belief in
              the benefits of our startup's services.
            </li>
            ...
            <li>
              Previous experience at a startup or consulting company is
              a plus
            </li>
            <li>
          ...
          <ul className="skills-text">
            ...
            <li>
              Network and collaborate with professionals in the health
              and wellness field.
            </li>
      ...
      <div>
        ...
        <div className="text-tab-flow">
          ...
          <p className="description-text">
            We are an 'early stage' pre-money nonprofit/ tech startup
            preparing for a proof-of-concept launch / seed-raise looking
            to recruit VOLUNTEERS (unpaid) as MARKETING SPECIALISTS.As
            the MARKETING SPECIALIST volunteer you will contribute to
          ...
          <ul className="responsibilities-text">
            ...
            <li>
              Evaluate market opportunities to support market-entry
            </li>
            <li>
            ...
            <li>
              ...
              for lead generation, content creation, website traffic,
              and other KPIs
            </li>
            <li>
      ...
      <div>
        ...
        <div className="text-tab-flow">
          ...
          <p className="note-text">
            ...
            connections in a professional setting, but you will also
            have the opportunity to demonstrate what companies value in
            ways other than paid employment: ability to get things done
        ...
        <div className="text-tab-flow">
          ...
          <ul className="responsibilities-text">
            ...
            <li>
              ...
              guidelines outlined in Robert's Rules and be able to
          ...
          <ul className="qualifications-text">
            ...
            <li>
              Familiarity with Meeting Facilitation: Strong experience
              in facilitating meetings and guiding discussions is
              essential. The Specialist should be comfortable managing
              diverse groups of participants and resolving conflicts
              within the context of Robert's Rules.
            </li>
            <li>
              Excellent Communication Skills: Effective communication is
              crucial for explaining and clarifying the rules to meeting
              participants. The Specialist should possess excellent
              verbal and written communication skills to convey complex
        ...
        <div className="text-tab-flow">
          ...
          <ul className="responsibilities-text">
            ...
            <li>
              ...
              lifecycle, including product and market research,
              competitor analysis, planning, positioning, requirements
              and roadmap development, and product launch
            </li>
            <li>
          ...
          <ul className="qualifications-text">
            ...
            <li>
              Exceptional writing and editing skills, combined with
      ...
      <div>
        ...
        <div className="text-tab-flow">
          ...
          <ul className="responsibilities-text">
            <li>
              Owning and creating a communication strategy for
              user-facing social media channels
            </li>
            <li>
              Help develop creative briefs and guide creative direction
              to meet objectives for all advertising and public-­facing
              communications, including print, digital, and video assets
            </li>
            <li>
              Growing, managing, and engaging our communities on
              Facebook, Instagram, LinkedIn, Slack, Discord, Twitter,
              and more
            </li>
            <li>
          ...
          <ul className="qualifications-text">
            <li>
              Bachelor’s degree (or equivalent) in marketing, business,
              or related field
            </li>
            <li>
              Proficiency with online marketing and social media
              strategy
            </li>
            <li>
