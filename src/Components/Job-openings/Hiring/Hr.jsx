    ...
    <div className="layerTwo-tab">
      <div>
        ...
        <div className="job-body">
          {hrVisible && (
            <div className="grid">
              <h2 className="grid-title" onClick={toggleAccordion("way")}>
            ...
            {accordion.way && (
              <div className="text-tab-flow">
                ...
                <p className="description-text">
                  ...
                  recruit VOLUNTEERS (unpaid) as HUMAN RESOURCES SPECIALIST/
                  GENERALIST.
                </p>
                <p className="description-text">
                ...
                <ul className="responsibilities-text">
                  ...
                  <li>
                    Use your high attention to detail to ensure new hire documents
                    are complete and available for audit when necessary
                  </li>
                  <li>
                    Coordinate office activities and operations to secure
                    efficiency and compliance to company policies
                  </li>
                  <li>
                    Create and distribute guidelines and FAQ documents about
