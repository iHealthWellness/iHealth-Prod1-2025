      ...
      <div>
        ...
        <div className="text-tab-flow">
          ...
          <p className="description-text">
            ...
            VOLUNTEERS (unpaid) as an EPIC Interface/ Integrations Specialist
            who will help us with signing and implementing integration solutions
            between EPIC and other systems.
          </p>
          <h3 className="responsibilities-title">Responsibilities</h3>
          <ul className="responsibilities-text">
            <li>
              Design and implement integration solutions between EPIC and other
              systems
            </li>
            <li>
              Be involved in the full life cycle of interface development
              including requirements gathering, building, testing, go-live and
              production support
            </li>
            <li>
              Provide integration environment technical knowledge and experience
              during the planning, execution, and management of integrating new
              applications into the existing environment
            </li>
            <li>
          ...
          <ul className="qualifications-text">
            ...
            <li>
              ...
              analysis/design, Integration/design, or web applications/design
            </li>
            <li>
            ...
            <li>
              Bachelor's degree in Computer Science, Information Technoloy, or
              related field
            </li>
            <li>
            ...
            <li>
              Ability to commit to a minimum of 4+ hour work weeks • Ability to
              attend weekly standup meeting (conference call with desktop/
              laptop access for screen sharing) Fluent in English
            </li>
          </ul>

          <p className="note-text">
            NOTE: Please note that candidates actively seeking CPT/Internships
            are ineligible for this particular volunteer position. Through your
        ...
        <div className="text-tab-flow">
          ...
          <p className="description-text">
            We are an 'early stage' pre-money nonprofit/ tech startup preparing
            for a proof-of-concept launch / seed-raise looking to recruit
            VOLUNTEERS as BACK-END ENGINEERS.
          </p>
          <p className="description-text">
            You will be critical to the development and launch of our backend
            infrastructure and integrations. The ideal candidate will have a
            unique blend of technical expertise, insatiable curiosity, and
            analytical mindset.
          </p>
          <h3 className="responsibilities-title">Responsibilities</h3>
          <ul className="responsibilities-text">
            <li>
              You will be responsible for development and maintenance of mission
              critical APIs
            </li>
            <li>
            ...
            <li>
              Mentoring your peers, with the notion that helping others means
              learning and growing themselves
            </li>
            <li>
              Successfully mentored other engineers in the past and have
              encouraged your peers to use software development best practices
          ...
          <ul className="qualifications-text">
            ...
            <li>Experience in building functional and effective platforms</li>
            <li>
            ...
            <li>
              Experience in the US Healthcare System and Pharmaceutical Patient
              Services
            </li>
        ...
        <div className="text-tab-flow">
          ...
          <p className="description-text">
            We are an 'early stage' pre-money nonprofit/ tech startup preparing
            for a proof-of-concept launch / seed-raise looking to recruit
            VOLUNTEERS (unpaid) as PRINCIPAL FRONT END ENGINEERS.
          </p>
          <p className="description-text">
          ...
          <p className="description-text">
            You’ll be helping to improve the healthcare experience for our users
            by making it simpler and more efficient for patients to book an
            appointment with and visit a doctor.
          </p>
          <h3 className="responsibilities-title">Responsibilities</h3>
          <ul className="responsibilities-text">
            <li>
              Working with technologies like React/Redux building the libraries
              and frameworks that power our front-end development
            </li>
            <li>
              You might build features or native mobile apps that help doctor’s
              visualize their value or develop core patient experiences that
              change the way patients interact with healthcare
            </li>
            <li>
              Mentoring your peers, with the notion that helping others means
              learning and growing themselves
          ...
          <ul className="qualifications-text">
            ...
            <li>
              ...
              object-oriented or functional languages. Some of the technologies
              we plan to use are React, C#, Scala, and Node.js, however we are
              language agnostic
            </li>
            <li>
              A passion for building platforms and understanding what makes a
              great platform - infrastructure as code, automation, libraries,
            ...
            <li>
              Experience within AWS environments and a high emphasis on testing
              is a plus
            </li>
            <li>
            ...
            <li>
              Proficient creating user interfaces and resolving cross-browser
        ...
        <div className="text-tab-flow">
          ...
          <p className="description-text">
            We are an 'early stage' pre-money nonprofit/ tech startup preparing
            for a proof-of-concept launch / seed-raise looking to recruit
            VOLUNTEERS (unpaid) as PRINCIPAL FULL-STACK ENGINEERS.
          </p>
          <p className="description-text">
            You’ll be helping to improve the healthcare experience for our users
            by making it simpler and more efficient for patients to book an
          ...
          <ul className="responsibilities-text">
            <li>
              You’ll balance project leadership, individual contribution, and
              mentorship
            </li>
            <li>
            ...
            <li>
              You’ll be using cutting-edge technology to help rapidly build and
              scale a new product in a brand new business space
            </li>
            <li>
            ...
            <li>
              ...
              interactions, real-time video visits, and new functionality that
              helps doctors optimize their experience
            </li>
            <li>
            ...
            <li>
              Making a meaningful impact as you own and release features in our
              CI environment that will impact patients, doctors, and alike
            </li>
            <li>
              Mentoring your peers, with the notion that helping others means
          ...
          <ul className="qualifications-text">
            <li>
              Passionate about building fully scalable platforms with the latest
              technologies
            </li>
            <li>
            ...
            <li>Motivated by building products that make healthcare easier</li>
            <li>
              Excited to use technology to enhance the consumer experience
            </li>
            <li>
              Passionate about building diverse and inclusive teams and culture
            </li>
            <li>
              Excited to lead projects and be a mentor for other engineers
            </li>
            <li>
              Passion for technology and the ability to think critically about
              performance, scalability, and reliability of software
            </li>
            <li>
              Implemented fast and efficient software solutions using
              object-oriented or functional languages • Some of the technologies
              we utilize are React, C#, Scala, and Node.js; however, we are
              language agnostic
            </li>
            <li>Designed and built user-facing web applications that scale</li>
            <li>5+ years of professional full-stack development experience</li>
            <li>
              Successfully mentored other engineers in the past and encouraged
              your peers to use software development best practices for code
            ...
            <li>
              Ability to commit to a minimum of 4+ hour work weeks • Ability to
              attend weekly standup meeting (conference call with desktop/
              laptop access for screen sharing)
            </li>
            <li>HealthTech experience is a plus</li>
          </ul>
        ...
        <div className="text-tab-flow">
          <h2 className="description-title">Description</h2>
          <p className="description-text">
            We are an 'early stage' pre-money nonprofit/ tech startup looking to
            recruit VOLUNTEERS (unpaid) as SENIOR PLATFORM DEVELOPER to help
            develop our cross platform online medical, and wellness care
            scheduling App (web, ios, android).
          </p>
          <p className="description-text">
            Future Salary would be promised for employees (after seed funding
            round).
          ...
          <ul className="responsibilities-text">
            ...
            <li>
              Participate in the full development life cycle, including design,
              coding, testing and production release
            </li>
            <li>
              The DEVELOPER PROJECT MANAGER volunteer is required to advise and
              contribute to the development of the product (web, ios, android)
            </li>
            <li>
            ...
            <li>
              Participate in the support of Major Incidents with Major Incident
              Management (MIM)
            </li>
            <li>
              ...
              technologies and apply this knowledge to effective monitoring of
              applications
            </li>
          </ul>
          <h3 className="qualifications-title">Qualifications</h3>
        ...
        <div className="text-tab-flow">
          ...
          <p className="description-text">
            We are an 'early stage' pre-money nonprofit/ tech startup looking to
            recruit VOLUNTEERS as SENIOR SOFTWARE ENGINEER to help develop our
            cross platform online medical, and wellness care App (web, ios,
            android). You're responsible for developing specifications, design,
            coding, testing, and debugging software applications using Java,
            SQL, NoSQL, HTML, JavaScript, TypeScript and related technologies.
          </p>
          <h3 className="responsibilities-title">Responsibilities</h3>
          <ul className="responsibilities-text">
            <li>
              Participate in the full development life cycle, including design,
              coding, testing and production release of the product (web, ios,
              android)
            </li>
            <li>
            ...
            <li>
              ...
              and assists other team members in implementing solution
            </li>
          ...
          <ul className="qualifications-text">
            ...
            <li>
              Implemented fast and efficient software solutions using
              object-oriented or functional languages. We are language agnostic
            </li>
            <li>
              A passion for building platforms and understanding what makes a
              great platform - infrastructure as code, automation, libraries,
