  ...
  return (
    <div className="layerTwo-tab">
      <div>
        ...
        {accordion.privacy && (
          <div className="grid">
            <h2 className="grid-text">Funding and Financial Specialist</h2>
        ...
        <div className="text-tab-flow">
          ...
          <p className="description-text">
            ...
            VOLUNTEERS (unpaid) as FUNDING AND FINANCIAL SPECIALIST to perform
            data analysis, create financial plans and identify funding partners
            and investors. Future Salary would be promised for employees (after
            seed funding round).
          </p>
          ...
          <ul className="responsibilities-text">
            ...
            <li>
              ...
              fundraising opportunities which include but not limited to Private
              Donors, GoFundMe, Grants, etc. to be used for office equipment and
              other recurring expenses
            </li>
            <li>
              (Future) Investment (spending money): Investing the firm’s funds
              in projects and securities that provide high returns in relation
              to their risks.
            </li>
          </ul>
          ...
          <ul className="qualifications-text">
            <li>
              ...
              company and/or progressive finance experience at a top management
              consulting firm, investment bank, private equity/VC fund
            </li>
            <li>
            ...
            <li>
              Bachelor's degree in Economics, Business, Finance, Accounting or
              related field; MBA or CPA a plus
            </li>
            <li>
        ...
        {accordion.privacy && (
          <div className="grid">
            <h2 className="grid-text">Fundraiser/ Development Officer</h2>
            <h2 className="grid-text">Remote</h2>
            <ArrowTab
              icon={setAccordion.privacy ? topArrow : downArrow}
              onClick={toggleAccordion("privacy")}
        ...
        <div className="text-tab-flow">
          ...
          <p className="description-text">
            We are an 'early stage' pre-money nonprofit/ tech startup preparing
            for a proof-of-concept launch / seed-raise looking to recruit
            VOLUNTEERS (unpaid) as a Fundraiser/ Development Officer who will
            develop a deep understanding of the organization and help us secure
            funding from a variety of donors and institutions. This is an
            exciting role on the front lines of our growth!
          </p>
          <h3 className="responsibilities-title">Responsibilities</h3>
          <ul className="responsibilities-text">
            <li>
            ...
            <li>
              Network and build relationship with potential donors, foundations,
              and partners and gather support and ensure their continued
              contributions to the organization
            </li>
            <li>
              Organize and execute fundraising events to help attract donors and
              spread awareness of iHealth’s mission the causes we support
            </li>
            <li>
          ...
          <ul className="qualifications-text">
            ...
            <li>
              Knowledge of and experience in executing events both in-person and
              online, understanding how to leverage volunteers and delegate
              tasks
            </li>
            <li>
              Strong interpersonal skills and the ability to build relationships
              with both individuals and corporations
            </li>
            <li>
              Experience writing proposals , event invitations, corporate
              newsletters, and any additional written communication as needed
            </li>
            <li>
