  ...
  return (
    ...
    <div>
      <div className="flex-tab">
        <h3 className="Text-header">DATA SCEINCE</h3>
        <BntTab
      ...
      <div className="text-tab-flow">
        ...
        <p className="description-text">
          ...
          to recruit VOLUNTEERS (unpaid) as WEB SCRAPING FOCUSED DATA
          ENGINEER.Future Salary would be promised for employees (after
          seed funding round).We’re searching for talented data
          scientists who are passionate about the acquisition of data
          with strong skills and knowledge of web scraping, web
          services, file transfers, and everything data.You’ll be
          helping to improve the healthcare experience for our users by
          making it simpler and more efficient for patients to book an
        ...
        <ul className="responsibilities-text">
          <li>
            ...
            websites and other collection strategies for third-party
            data sources
          </li>
          <li>
            Configure data extraction and transformations in an
            individual contributor role across multiple data sources
          </li>
          <li>
          ...
          <li>
            ...
            format, being thorough about testing on many different
            pages, and so on
          </li>
        </ul>
        ...
        <ul className="qualifications-text">
          ...
          <li>
            HealthTech experience is a plusJoin us, you win, we both
            win!!
          </li>
        </ul>
