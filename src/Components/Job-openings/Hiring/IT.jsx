        ...
        <div className="job-body">
          ...
          <div className="text-tab-flow">
            ...
            <p className="description-text">
              ...
              to recruit VOLUNTEERS (unpaid) as SALESFORCE ARCHITECT (HEALTH
            ...
            <ul className="responsibilities-text">
              ...
              <li>
                Provide technological expertise and advice to IT leadership
                in the development of strategic information technology plans
              ...
              <li>
                Health Cloud implementation, Salesforce Lightning,
                Salesforce Configuration, Customization, Service Cloud
                Development , Integration with 3rd party systems and custom
                development
              </li>
              <li>
              ...
              <li>
                Support users & Business Analysts to troubleshoot
                application issues and develop creative solutions to support
                business needs
              </li>
              <li>
              ...
              <li>
                Monitor new Salesforce release features and functionality
