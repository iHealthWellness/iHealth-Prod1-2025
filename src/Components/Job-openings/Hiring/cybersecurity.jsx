    ...
    <div className="layerTwo-tab">
      <div>
        ...
        <div className="job-body">
          ...
          <hr />
          {accordion.show && (<div className="text-tab-flow">
            ...
            <p className="description-text">
              ...
              to recruit VOLUNTEERS (unpaid) as COPYWRITERS. Future Salary
            ...
            <ul className="responsibilities-text">
              ...
              <li>
                Research and understand a client’s needs and target
                audiences, through online searches, reviews of existing
                research, interviews with subject-matter experts, and
                in-person meetings
              </li>
              <li>
                Write original copy and edit content for a range of
                marketing and communications materials • Collaborate with a
                team of account managers and creative staff, from concept
                development to delivery of final product • Present copy
                concepts and final deliverables to internal team — and to
                client representative when requested — and participate
                occasionally in client pitches
              </li>
              <li>
              ...
              <li>
                Continuously monitor and adapt messaging strategy to
                increase open and click-through rates, customer acquisition
                and engagement, and support Search Engine Optimization goals
              </li>
              <li>
            ...
            <ul className="qualifications-text">
              ...
              <li>
                ...
                email marketing, website content, product promotions and
                blog style content (please include link to portfolio)
              </li>
              <li>
                Strong understanding of digital best practices and the
                ability to execute against a broad variety of digital assets
                • Ability to generate compelling copy for both brand and
                performance marketing initiatives, and experience with
                developing copy for Search Engine Optimization
              </li>
              <li>
                Excellent writing, editing, research and grammatical skills
              </li>
              <li>
                Ability to work independently or with a team to meet
                deadlines
              </li>
              <li>
