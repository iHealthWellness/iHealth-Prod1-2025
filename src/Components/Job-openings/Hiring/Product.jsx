      ...
      <div>
        ...
        <div className="text-tab-flow">
          ...
          <p className="description-text">
            ...
            for a proof-of-concept launch / seed-raise seeking a PRO BONO
            GENERALIST to assist in all aspects of the management and
            administration of Non-profit formation, regulation and compliance.
          </p>
          ...
          <ul className="responsibilities-text">
            ...
            <li>
              Track, update, and record the status of pro bono matters in the
              Firm's data repository
            </li>
            <li>
            ...
            <li>
              Assist in developing marketing content for Firm's website and blog
            </li>
            <li>
              Work with Information Technology team to update and enhance the
              training materials and opportunity listings
            </li>
            <li>Work with Finance team to respond to audits and surveys</li>
            <li>Perform research and/or other special projects</li>
            <li>
              Ability to carry out certain tasks with minimal supervision after
          ...
          <ul className="qualifications-text">
            ...
            <li>
              Proficiency in Google Suite • Ability to commit to a minimum of 4+
              hour work weeks
            </li>
            <li>
