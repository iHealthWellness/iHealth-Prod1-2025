      ...
      <div className="page-text">
        ...
        <div className="">
          <div className="text-header-tab">
            ...
            {showContent.privacy && (
              <div>
                <p onClick={toggleContentVisible('privacy')} >
                  ...
                  to improve our website and to provide you with a more personalized
            ...
            {showContent.errors && (
              <div> <p onClick={toggleContentVisible('errors')}>
            ...
            {showContent.thirdParty && (
              <div>
                <p onClick={toggleContentVisible('thirdParty')} >The Services may contain links to third-party websites or resources.
          ...
          <div className="text-header-tab">
            ...
            {showContent.termination && (
              <div>
                <p onClick={toggleContentVisible('termination')}> We may terminate your access to and use of the services, at our sole discretion,
          ...
          <div className="text-header-tab">
            ...
            {showContent.disclaimer && (<div>
              <p onClick={toggleContentVisible('disclaimer')}>The information provided on this website is for informational purposes only and is not intended to be a substitute for professional medical advice,
