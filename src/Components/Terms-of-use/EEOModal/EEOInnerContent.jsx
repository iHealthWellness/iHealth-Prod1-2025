...
import logo from "src/Assets/Brand/logo-nav-desktop.png";

// import { useToggle } from "./toggleModal";
...
const EqualOpportunityPolicy = ({isModalOpen, toggleModal}) => {
    ...
    <>
     {isModalOpen && (
        <div className={styles.modal}>
            <img className={styles.closeIcon} src={closeIcon} onClick={toggleModal} alt=""/>
          <div className={styles.header}>
            <img src={logo} alt="" />
            <h1 className={styles.foundationName}>
              iHealth and Wellness Foundation, Inc.
            </h1>
            <h2 className={styles.subheader}>Equal Opportunity Policy</h2>
            <p className={styles.date}>Effective: May 23, 2023</p>
          </div>
