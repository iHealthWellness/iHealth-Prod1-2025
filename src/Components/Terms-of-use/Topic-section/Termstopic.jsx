    ...
    <>
      ...
      <div>
        ...
        <div className="terms5">
          ...
          {isExpanded11 && (
            <div>
              <p>
                ...
                address when you sign up for our services. We use this
                ...
                except when required by law or when necessary to provide you
                with the services you have requested. We take appropriate
                ...
                provide you with a more personalized experience. You can choose
                to disable cookies in your web browser, but this may limit your
                use of our website.
                <br />
                <br />
                We may also use third-party services, such as Google Analytics,
                to analyze website traffic and usage. These third-party services
                may collect and use your information in accordance with their
          ...
          {/* Disclaimer section */}
          <div className="expand-div">
            <h3 className="header31" id="disclaimer" onClick={handleToggle22}>
              Disclaimer
            </h3>
          ...
          {isExpanded22 && (
            <div>
              <p>
                ...
                <br />
                <br />
                The website owner does not endorse or recommend any specific
                healthcare provider listed on the site, and is not responsible
                for the quality or performance of any healthcare provider listed
                on the site.
                <br />
                <br />
                The website owner does not guarantee the accuracy, completeness,
                or timeliness of the information provided on the site. Users are
                encouraged to verify the credentials and qualifications of any
                healthcare provider listed on the site before making an
                appointment.
                <br />
                <br />
                By using this website, users agree to hold the website owner
                harmless from any claims or damages arising from the use of the
